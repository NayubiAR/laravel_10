<div>
    {{-- Disini dilakukan pengecheckkan pada user dengan mengambil $idea yang sudah diberikan pada data
    perulangan di view dashboard dan data user $idea dilakukan pengecheckan ke method likesIdea di model user --}}
    @auth
